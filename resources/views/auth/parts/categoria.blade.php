    ...
    <div class="container-fluid">
        ...
        <div class="mt-2 wrapper-familia font-opensans">
            <div class="card rounded-0">
                <div class="card-body rounded-0">
                    <div class="row">
                        @foreach( $data[ "categorias" ] AS $f )
                        <div class="col-12 col-md-6 col-lg-4 my-3">
                            <a href="{{ URL::to('/adm/familia/' . $f->familia[ 'url' ] . '/' . $f[ 'url' ] . '/' . $f[ 'id' ]) }}" class="border bg-white d-block familia">
        ...
        <div class="mt-2 d-flex">
            ...
            <div class="ml-4">
                ...
                <span class="ml-2">Agregar productos</span>
            </div>
            <div class="ml-4">
...
<script>
    ...
    window.elementos = @json( $data[ "categorias" ] );
    ...
    add = function(t, id = 0, data = null) {
        ...
        $( `#${window.pyrus.name}_familia_id` ).val( window.familia.id );
    ...
    producto = function( t , id ) {
        let index = $( t ).closest( "tr" ).index();
        let categoria = window.elementos[ index ];
        let url = `{{ url('/adm/familia/${window.familia.url}/${categoria.url}/${id}') }}`
        window.location = url;
    };
