    ...
    <div class="container-fluid">
                ...
                <div class="card-body rounded-0">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 my-3">
                            <a href="{{ URL::to('/adm/familia/' . $f[ 'url' ] . '/' . $f[ 'id' ]) }}" class="border bg-white d-block familia">
        ...
        <div class="mt-2 d-flex">
            ...
            <div class="ml-4">
                ...
                <span class="ml-2">Agregar categoría</span>
            </div>
            <div class="ml-4">
...
<script>
    window.pyrus = new Pyrus("familia", null, src);
    window.elementos = @json($data["familias"]);
    ...
    categoriaFunction = function( t , id ) {
        let index = $( t ).closest( "tr" ).index();
        let familia = window.elementos[ index ];
        let url = `{{ url('/adm/familia/${familia.url}/${id}') }}`
        window.location = url;
    };
    ...
    init = function( callbackOK ) {
        ...
        window.pyrus.elements( $( "#tabla" ) , `{{ asset('/') }}` , window.elementos , [ "e" , "d" ] , [ { icon : '<i class="fas fa-table"></i>' , class: 'btn-primary' , function : 'categoria' } ] );
